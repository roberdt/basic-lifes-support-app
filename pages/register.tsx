...
export default function RegisterPage() {
  ...
  const onSubmit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        setMessage(payload.message || 'Unable to submit request.')
        return
      }
  ...
  return (
    <>
      <Head>
        <title>Register | Basic Life Support</title>
      </Head>
      ...
      >
        ...
        >
          <Stack spacing={2} component="form" onSubmit={onSubmit}>
            <Box>
              <Typography variant="h4">Request calendar access</Typography>
              <Typography color="text.secondary">
                Submit your details and an administrator will receive an email request.
              </Typography>
            </Box>
